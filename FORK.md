...
| 5b | Prevent long Qwen3-ASR transcript truncation with per-model 10/20 s segmentation, 200 ms relative-quiet pause detection, and a 512-token output budget | `packages/web/server/lib/dictation/` catalog, worker client, stream manager, audio helper, recognizer, tests, and docs | DONE |
